...
<div className="flex gap-4 items-center"><Link href="/">Strona główna</Link> <Link href="/cmiczek">Ćmiczek</Link> <Link href="/testing">testing</Link> <Link href="/sprawdzenie">sprawdzenie</Link></div>
        </nav>
