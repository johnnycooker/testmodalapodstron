      ...
      const GeneratedPage: React.FC = () => {
        return (
          ...
          <img src="https://polszczyzna.pl/wp-content/uploads/2021/04/essa-co-to-znaczy-co-to-jest-slang-miejski-slownik-potoczny-jezyk-czym-jest-essa-synonim-super-ekstra-slownik-PolszczyznaPL.png" alt="" className="w-[90.03028100775195%] md:w-[48.70299796747969%] xl:w-[37.23958333333334%] h-[28.77507919746568%] md:h-[43.66420274551214%] left-[4.407703488372091%] md:left-[2.8620426829268295%] xl:left-[8.697916666666666%] top-[17.74023231256604%] md:top-[21.04984201199209%] xl:top-[38.225976768743415%]" style={{ position: "absolute" }} />
<nav className="flex items-center justify-between p-4 h-[16.31168831168831%]" style={{ backgroundColor: "#1b92c5" }}>
          <div className="flex gap-4 items-center"><Link href="/">main</Link> <Link href="/cmiczek">cmiczek</Link></div>
<div className="flex gap-4 items-center"><img src="https://24jgora.pl/static/files/gallery/146/1381823_1670412077.jpg" alt="logo" className="w-[100px] md:w-[300px] h-[50px] md:h-[100px] ml:[5%] object-fill" /></div>
<div className="flex gap-4 items-center"><Link href="/testing">testing</Link> <Link href="/sprawdzenie">sprawdzenie</Link></div>
        </nav>
